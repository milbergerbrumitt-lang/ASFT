...
def activation_regularization(
    ...
    if regularizer_type != "offdiag_cov":
        raise ValueError(
            f"Unsupported activation_regularizer_type={regularizer_type!r}. "
            "Only 'offdiag_cov' is currently supported."
        )
    if labels is None:
...
def train(
    ...
    **kwargs
    ...
    if use_activation_regularizer:
        ...
        if normalized_activation_regularizer_type != "offdiag_cov":
            raise ValueError(
                f"Unsupported activation_regularizer_type={activation_regularizer_type!r}. "
                "Only 'offdiag_cov' is supported."
            )
